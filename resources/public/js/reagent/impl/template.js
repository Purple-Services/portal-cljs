...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20763__auto__,writer__20764__auto__,opt__20765__auto__){
return cljs.core._write.call(null,writer__20764__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__21861 = o;
(G__21861[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__21863__i < G__21863__a.length) {G__21863__a[G__21863__i] = arguments[G__21863__i + 0]; ++G__21863__i;}
  args = new cljs.core.IndexedSeq(G__21863__a,0);
} 
...
if(cljs.core.truth_((function (){var and__20145__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__20145__auto__){
var and__20145__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__20145__auto____$1){
var and__20145__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__21869 = jsprops;
(G__21869["defaultValue"] = value);

(G__21869["onChange"] = ((function (G__21869,v,value,on_change){
return (function (p1__21867_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21867_SHARP_);
});})(G__21869,v,value,on_change))
);
...
var vec__21876 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21876,(0),null);
var id = cljs.core.nth.call(null,vec__21876,(1),null);
var class$ = cljs.core.nth.call(null,vec__21876,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___21881 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21881 == null)){
} else {
var key_21882 = temp__4661__auto___21881;
(jsprops["key"] = key_21882);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21884 = (new reagent.impl.template.NativeWrapper());
(G__21884["name"] = c);
...
var len__21232__auto___21890 = arguments.length;
var i__21233__auto___21891 = (0);
while(true){
if((i__21233__auto___21891 < len__21232__auto___21890)){
args__21239__auto__.push((arguments[i__21233__auto___21891]));

var G__21892 = (i__21233__auto___21891 + (1));
i__21233__auto___21891 = G__21892;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21240__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21888){
var G__21889 = cljs.core.first.call(null,seq21888);
var seq21888__$1 = cljs.core.next.call(null,seq21888);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21889,seq21888__$1);
});
...
break;
default:
var G__21896 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21896;
continue;
...
var n__21072__auto___21899 = a.length;
var i_21900 = (0);
while(true){
if((i_21900 < n__21072__auto___21899)){
(a[i_21900] = reagent.impl.template.as_element.call(null,(a[i_21900])));

var G__21901 = (i_21900 + (1));
i_21900 = G__21901;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21072__auto___21902 = a.length;
var i_21903 = (0);
while(true){
if((i_21903 < n__21072__auto___21902)){
var val_21904 = (a[i_21903]);
if((cljs.core.vector_QMARK_.call(null,val_21904)) && ((reagent.impl.template.key_from_vec.call(null,val_21904) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21903] = reagent.impl.template.as_element.call(null,val_21904));
...
var ctx = ({});
var vec__21909 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21909,(0),null);
var derefed = cljs.core.nth.call(null,vec__21909,(1),null);
...
var G__21913 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21913) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21913){
...
//# sourceMappingURL=template.js.map?rel=1473888608424